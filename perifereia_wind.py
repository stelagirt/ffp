...
def attribute_geodataframe_numpy(x, res_max, dir_max, dom_vel, dom_dir,M):
    x_pos, y_pos = take_point_position(x[10], x[11])
    res_max_values = -1000
    dir_max_values = -1000
    dom_vel_values = -1000
    dom_dir_values = -1000
...
#start = time.time()
dataset_join = gpd.read_file('/home/sg/Projects/vravrona/zonal/clima/17082011_temp/17082011_temp.shp')
...
wind_df.to_csv('/home/sg/Projects/vravrona/zonal/clima/17082011_temp_wind')
