...
dataset_np = no_fire_static.to_numpy()

dates_full = np.array(no_fire_static.firedate_g.drop_duplicates())
...
for year in range(2010,2019):
    ...
    for date in dates:
        ...
        mean_temp = []
        try:
            min_temp, max_temp, mean_temp = extract_arrays(datesar[date])
