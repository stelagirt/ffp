...
temps = pygrib.open("/users/pa21/sgirtsou/transfered_files/data/gribs/feature_data/dewpoint_temp_2020.grb")
print("Temps ...... ok")
dew_temps = pygrib.open("/users/pa21/sgirtsou/transfered_files/data/gribs/feature_data/dewpoint_temp_2020.grb")
print("Dew Temps ...... ok")
wind = pygrib.open("/users/pa21/sgirtsou/transfered_files/data/gribs/feature_data/wind_2020.grb")
print("Wind ...... ok")
precs = pygrib.open("/users/pa21/sgirtsou/transfered_files/data/gribs/feature_data/precipitation_2020.grb")
print("precs ...... ok")
